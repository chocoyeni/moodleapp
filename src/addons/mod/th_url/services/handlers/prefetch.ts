...
import {
    ...
    ADDON_MOD_TH_URL_MODNAME,
    ADDON_MOD_TH_URL_COMPONENT,
} from '../../constants';
...
export class AddonModThUrlPrefetchHandlerService extends CoreCourseResourcePrefetchHandlerBase {
...
export const AddonModThUrlPrefetchHandler = makeSingleton(AddonModThUrlPrefetchHandlerService);
